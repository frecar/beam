...
export const reconnectDisconnectBtn = document.getElementById(
  'reconnect-disconnect-btn'
...
export const adminSessionsTbody = document.getElementById(
  'admin-sessions-tbody'
...
export function showReconnectOverlay(
  mode: 'disconnected' | 'replaced' | 'auto-reconnecting' = 'disconnected',
